    ...
    const fetchProfileAndGenerate = async () => {
      try {
        ...
        const { data: aiData, error: aiError } = await supabase.functions.invoke(
          ...
          {
            body: { productType: "credit_card", profile },
          }
        );
        ...
        setFormData({
          ...
          requestedCreditLimit: aiData.data.requestedCreditLimit,
          primaryUse: aiData.data.primaryUse,
          preferredCardDesign: aiData.data.preferredCardDesign,
        });
      } catch (error: any) {
        toast({
          title: "Error",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.from("applications").insert({
        ...
        credit_limit: formData.requestedCreditLimit,
        status: "pending",
      });
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, requestedCreditLimit: parseInt(e.target.value) })}
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.primaryUse} onValueChange={(value) => setFormData({ ...formData, primaryUse: value })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="everyday purchases">Everyday Purchases</SelectItem>
              ...
              <div className="space-y-2">
                <Label htmlFor="preferredCardDesign">Preferred Card Design</Label>
                <Select value={formData.preferredCardDesign} onValueChange={(value) => setFormData({ ...formData, preferredCardDesign: value })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription className="space-y-2 pt-4">
              <p>Your credit card application has been successfully submitted.</p>
